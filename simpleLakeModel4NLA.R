...
# quick compare PRISM and NLDAS precip
plot(PRISM$MAP_cm,NLDASprecip$dailyNLDASprecip_mm*365,xlab="PRISM mean annual precipitation (mm)",ylab="NLDAS mean annual precipitation (mm)")
